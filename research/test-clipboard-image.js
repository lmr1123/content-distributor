...
async function test() {
  ...
  // 模拟粘贴事件
  console.log('模拟粘贴图片...');
  const pasteResult = await page.evaluate((base64Image) => {
  ...
  await page.waitForTimeout(3000);
  await page.screenshot({ path: '/tmp/xhs-after-paste.png', fullPage: false });
  console.log('截图: /tmp/xhs-after-paste.png');
